        ...
        <table id="example1" class="table table-borderd table-sm table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="fw-light">{{$record->brand}}</td>
                    <td class="fw-light">{{$record->quantity}}</td>
                    <td class="fw-light">{{$record->size}}</td>
                    <td class="fw-light">{{$record->store}}</td>
                    <td class="fw-light">{{$record->delivery_date}}</td>
